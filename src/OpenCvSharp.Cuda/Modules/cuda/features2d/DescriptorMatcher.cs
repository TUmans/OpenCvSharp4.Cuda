...
public class DescriptorMatcher : Algorithm
{
    ...
    protected DescriptorMatcher(IntPtr smartPtr, IntPtr rawPtr)
          : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods_cuda.cuda_DescriptorMatcher_delete(p)))
    {
    }
    ...
    public static DescriptorMatcher CreateBFMatcher(NormTypes normType = NormTypes.L2)
    {
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_create((int)normType, out var smartPtr));
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_get(smartPtr, out var rawPtr));
    ...
    public void Add(IEnumerable<GpuMat> descriptors)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_add(RawPtr, descriptorsPtrs, descriptorsPtrs.Length));
        GC.KeepAlive(this);
    ...
    {
        ThrowIfDisposed();
        NativeMethods.HandleException(NativeMethods_cuda.cuda_DescriptorMatcher_clear(RawPtr));
        GC.KeepAlive(this);
    }
    ...
    public GpuMat[] GetTrainDescriptors()
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_getTrainDescriptors(RawPtr, matVec.CvPtr));
        GC.KeepAlive(this);
    ...
    {
        ThrowIfDisposed();
        NativeMethods.HandleException(NativeMethods_cuda.cuda_DescriptorMatcher_isMaskSupported(RawPtr, out int val));
        GC.KeepAlive(this);
        return val != 0;
    }
    ...
    {
        ThrowIfDisposed();
        NativeMethods.HandleException(NativeMethods_cuda.cuda_DescriptorMatcher_train(RawPtr));
        GC.KeepAlive(this);
    }
        ...
        OpenCvSharp.Cuda.InputArray? mask = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_match1(
                RawPtr, queryDescriptors.CvPtr, trainDescriptors.CvPtr,
                matchesVec.CvPtr, Cv2Cuda.ToPtr(mask)));
        GC.KeepAlive(this);
        ...
        int k, OpenCvSharp.Cuda.InputArray? mask = null, bool compactResult = false)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_knnMatch1(
                RawPtr, queryDescriptors.CvPtr, trainDescriptors.CvPtr,
                matchesVec.CvPtr, k, Cv2Cuda.ToPtr(mask), compactResult ? 1 : 0));
        GC.KeepAlive(this);
        GC.KeepAlive(queryDescriptors);
        GC.KeepAlive(trainDescriptors);
        GC.KeepAlive(mask);
        ...
        float maxDistance, OpenCvSharp.Cuda.InputArray? mask = null, bool compactResult = false)
    {
        ...
        using var matchesVec = new VectorOfVectorDMatch();
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_radiusMatch1(
                RawPtr, queryDescriptors.CvPtr, trainDescriptors.CvPtr,
                matchesVec.CvPtr, maxDistance, Cv2Cuda.ToPtr(mask), compactResult ? 1 : 0));
        GC.KeepAlive(this);
        GC.KeepAlive(queryDescriptors);
        GC.KeepAlive(trainDescriptors);
        GC.KeepAlive(mask);
    ...
    public DMatch[] Match(OpenCvSharp.Cuda.InputArray queryDescriptors, OpenCvSharp.Cuda.InputArray[]? masks = null)
    {
        ...
        using var matchesVec = new VectorOfDMatch();
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_match2(
    ...
    public DMatch[][] KnnMatch(OpenCvSharp.Cuda.InputArray queryDescriptors, int k, OpenCvSharp.Cuda.InputArray[]? masks = null, bool compactResult = false)
    {
        ...
        using var matchesVec = new VectorOfVectorDMatch();
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_knnMatch2(
    ...
    public DMatch[][] RadiusMatch(OpenCvSharp.Cuda.InputArray queryDescriptors, float maxDistance, OpenCvSharp.Cuda.InputArray[]? masks = null, bool compactResult = false)
    {
        ...
        using var matchesVec = new VectorOfVectorDMatch();
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_radiusMatch2(
        ...
        OpenCvSharp.Cuda.OutputArray matches, OpenCvSharp.Cuda.InputArray? mask = null, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_matchAsync1(RawPtr, queryDescriptors.CvPtr, trainDescriptors.CvPtr, matches.CvPtr, mask?.CvPtr ?? IntPtr.Zero, stream?.CvPtr ?? IntPtr.Zero));
        ...
        GpuMat[]? masks = null, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_matchAsync2(RawPtr, queryDescriptors.CvPtr, matches.CvPtr, masksPtrs, masksPtrs.Length, stream?.CvPtr ?? IntPtr.Zero));
        ...
        OpenCvSharp.Cuda.OutputArray matches, int k, OpenCvSharp.Cuda.InputArray? mask = null, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_knnMatchAsync1(RawPtr, queryDescriptors.CvPtr, trainDescriptors.CvPtr, matches.CvPtr, k, mask?.CvPtr ?? IntPtr.Zero, stream?.CvPtr?? IntPtr.Zero));
    ...
    public void KnnMatchAsync(OpenCvSharp.Cuda.InputArray queryDescriptors, OpenCvSharp.Cuda.OutputArray matches, int k, GpuMat[]? masks = null, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_knnMatchAsync2(RawPtr, queryDescriptors.CvPtr, matches.CvPtr, k, masksPtrs, masksPtrs.Length, stream?.CvPtr ?? IntPtr.Zero));
    ...
    public void RadiusMatchAsync(OpenCvSharp.Cuda.InputArray queryDescriptors, OpenCvSharp.Cuda.InputArray trainDescriptors, OpenCvSharp.Cuda.OutputArray matches, float maxDistance, OpenCvSharp.Cuda.InputArray? mask = null, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_radiusMatchAsync1(RawPtr, queryDescriptors.CvPtr, trainDescriptors.CvPtr, matches.CvPtr, maxDistance, mask?.CvPtr ?? IntPtr.Zero, stream?.CvPtr ?? IntPtr.Zero));
    ...
    public void RadiusMatchAsync(OpenCvSharp.Cuda.InputArray queryDescriptors, OpenCvSharp.Cuda.OutputArray matches, float maxDistance, GpuMat[]? masks = null, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_radiusMatchAsync2(RawPtr, queryDescriptors.CvPtr, matches.CvPtr, maxDistance, masksPtrs, masksPtrs.Length, stream?.CvPtr ?? IntPtr.Zero));
    ...
    public DMatch[] MatchConvert(OpenCvSharp.Cuda.InputArray gpuMatches)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_matchConvert(RawPtr, gpuMatches.CvPtr, matchesVec.CvPtr));
    ...
    public DMatch[][] KnnMatchConvert(OpenCvSharp.Cuda.InputArray gpuMatches, bool compactResult = false)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_knnMatchConvert(RawPtr, gpuMatches.CvPtr, matchesVec.CvPtr, compactResult ? 1 : 0));
    ...
    public DMatch[][] RadiusMatchConvert(OpenCvSharp.Cuda.InputArray gpuMatches, bool compactResult = false)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_DescriptorMatcher_radiusMatchConvert(RawPtr, gpuMatches.CvPtr, matchesVec.CvPtr, compactResult ? 1 : 0));
