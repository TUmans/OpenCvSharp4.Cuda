...
namespace OpenCvSharp.Cuda
{
    ...
    public class NvidiaOpticalFlow_1_0 : NvidiaHWOpticalFlow
    {
        private NvidiaOpticalFlow_1_0(IntPtr smartPtr, IntPtr rawPtr)
            : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods_cuda.cuda_NvidiaOpticalFlow_1_0_delete(p)))
        {
        }
            ...
            Stream? outputStream = null)
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_createNvidiaOpticalFlow_1_0(
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_NvidiaOpticalFlow_1_0_get(smartPtr, out var rawPtr));
        ...
        public void UpSampler(OpenCvSharp.Cuda.InputArray flow, Size imageSize, int gridSize, OpenCvSharp.Cuda.InputOutputArray upsampledFlow)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_NvidiaOpticalFlow_1_0_upSampler(
