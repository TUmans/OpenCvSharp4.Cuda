...
namespace OpenCvSharp.Cuda
{
    ...
    public sealed class NvidiaOpticalFlow_2_0 : NvidiaHWOpticalFlow
    {
        private NvidiaOpticalFlow_2_0(IntPtr smartPtr, IntPtr rawPtr)
            : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods_cuda.cuda_NvidiaOpticalFlow_2_0_delete(p)))
        {
        }
            ...
            Stream? outputStream = null)
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_createNvidiaOpticalFlow_2_0(
            ...
            Stream? outputStream = null)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_createNvidiaOpticalFlow_2_0_roi(
        ...
        public void ConvertToFloat(InputArray flow, OutputArray floatFlow)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_NvidiaOpticalFlow_2_0_convertToFloat(RawPtr, flow.CvPtr, floatFlow.CvPtr));
