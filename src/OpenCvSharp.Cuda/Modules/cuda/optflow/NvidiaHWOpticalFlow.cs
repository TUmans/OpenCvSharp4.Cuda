...
public class NvidiaHWOpticalFlow: Algorithm
{
        ...
        OpenCvSharp.Cuda.CudaOutputArray? cost = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_NvidiaHWOpticalFlow_calc(
    ...
    {
        ThrowIfDisposed();
        NativeMethods.HandleException(NativeMethods_cuda.cuda_NvidiaHWOpticalFlow_collectGarbage(RawPtr));
        GC.KeepAlive(this);
    }
    ...
    public int GridSize
    {
        ...
        {
            ThrowIfDisposed();
            NativeMethods.HandleException(NativeMethods_cuda.cuda_NvidiaHWOpticalFlow_getGridSize(RawPtr, out var ret));
            GC.KeepAlive(this);
            return ret;
        }
    }
