...
public class BackgroundSubtractorMOG : BackgroundSubtractor
{
    protected BackgroundSubtractorMOG(IntPtr smartPtr, IntPtr rawPtr)
           : base(smartPtr, rawPtr, p => NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_delete(p))) { }
    ...
    {
        NativeMethods.HandleException(NativeMethods_cuda.cuda_createBackgroundSubtractorMOG(
            history, nmixtures, backgroundRatio, noiseSigma, out var smartPtr));

        NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_get(smartPtr, out IntPtr rawPtr));
            ...
            double learningRate = -1, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_apply(
        ...
        OpenCvSharp.Cuda.OutputArray fgmask, double learningRate = -1, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_BackgroundSubtractorMOG_apply_withMask(
    ...
    public virtual void GetBackgroundImage(OpenCvSharp.Cuda.OutputArray backgroundImage, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_BackgroundSubtractorMOG_getBackgroundImage(
    ...
    {
        get { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_getBackgroundRatio(RawPtr, out double val)); GC.KeepAlive(this); return val; }
        set { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_setBackgroundRatio(RawPtr, value)); GC.KeepAlive(this); }
    }

    public int History
    {
        get { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_getHistory(RawPtr, out int val)); GC.KeepAlive(this); return val; }
        set { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_setHistory(RawPtr, value)); GC.KeepAlive(this); }
    }

    public int NMixtures
    {
        get { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_getNMixtures(RawPtr, out int val)); GC.KeepAlive(this); return val; }
        set { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_setNMixtures(RawPtr, value)); GC.KeepAlive(this); }
    }

    public double NoiseSigma
    {
        get { ThrowIfDisposed(); NativeMethods.HandleException(NativeMethods_cuda.cuda_BackgroundSubtractorMOG_getNoiseSigma(RawPtr, out double val)); GC.KeepAlive(this); return val; }
