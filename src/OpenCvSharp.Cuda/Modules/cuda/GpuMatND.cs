...
namespace OpenCvSharp.Cuda
{
    ...
    public sealed class GpuMatND : CvObject
    {
        public GpuMatND()
        {
            NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_new1(out var ptr));
            InitSafeHandle(ptr);
        }
        ...
        public GpuMatND(int[] sizes, MatType type)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_new2(sizes.Length, sizes, type.Value, out var ptr));
            InitSafeHandle(ptr);
        }
        ...
        private void InitSafeHandle(IntPtr p, bool ownsHandle = true)
        {
            SetSafeHandle(new OpenCvCudaPtrSafeHandle(p, ownsHandle,
                static h => NativeMethods_cuda.cuda_GpuMatND_delete(h)));
        }
        ...
        public void Create(int[] sizes, MatType type)
        {
            ...
            if (sizes == null) throw new ArgumentNullException(nameof(sizes));
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_create(ptr, sizes.Length, sizes, type.Value));
            GC.KeepAlive(this);
        }
        ...
        {
            ThrowIfDisposed();
            NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_empty(CvPtr, out int res));
            GC.KeepAlive(this);
            return res != 0;
        }
        ...
        public GpuMatND Clone(Stream? stream)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_clone(ptr, out var resPtr, stream?.CvPtr ?? IntPtr.Zero));
        ...
        public GpuMat CreateGpuMatHeader()
        {
            ThrowIfDisposed();
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_createGpuMatHeader1(ptr, out var resPtr));
            GC.KeepAlive(this);
        ...
        public GpuMat CreateGpuMatHeader(int[] indices, Range rowRange, Range colRange)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_createGpuMatHeader2(ptr, indices, indices.Length, rowRange, colRange, out var resPtr));
        ...
        public void Download(OpenCvSharp.OutputArray dst, Stream? stream = null)
        {
            ...
            {
                NativeMethods.HandleException(
                    NativeMethods_cuda.cuda_GpuMatND_download(ptr, dst.CvPtr));
            }
            else
            {
                NativeMethods.HandleException(
                    NativeMethods_cuda.cuda_GpuMatND_download_stream(ptr, dst.CvPtr, stream.CvPtr));
            }
        ...
        public ulong ElemSize
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_elemSize(ptr, out var ret));
                GC.KeepAlive(this);
                return (ulong)ret;
            }
        }
        ...
        public ulong ElemSize1
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_elemSize1(ptr, out var ret));
                GC.KeepAlive(this);
                return (ulong)ret;
            }
        }
        ...
        public bool External
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_external(ptr, out var ret));
                GC.KeepAlive(this);
                return ret != 0;
            }
        }
        ...
        public IntPtr DevicePtr
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_getDevicePtr(ptr, out var ret));
                GC.KeepAlive(this);
                return ret;
            }
        }
        ...
        public bool IsContinuous
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_isContinuous(ptr, out var ret));
                GC.KeepAlive(this);
                return ret != 0;
            }
        }
        ...
        public bool IsSubmatrix
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_isSubmatrix(ptr, out var ret));
                GC.KeepAlive(this);
                return ret != 0;
            }
        }
        ...
        public static explicit operator GpuMat(GpuMatND mat)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_opToGpuMat(mat.ptr, out var resPtr));
        ...
        public GpuMatND this[params Range[] ranges]
        {
            get
            {
                ...
                NativeMethods.HandleException(
                    NativeMethods_cuda.cuda_GpuMatND_opSubMat(ptr, starts, ends, ranges.Length, out var resPtr));
        ...
        public GpuMat ToGpuMat(int[] indices, Range rowRange, Range colRange)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_opIndex2D(
        ...
        public void AssignFrom(GpuMatND other)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_opAssign(ptr, other.ptr));
        ...
        {
            ThrowIfDisposed();
            NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_release(ptr));
        }
        ...
        public void Swap(GpuMatND other)
        {
            ...
            ThrowIfDisposed();
            other.ThrowIfDisposed();
            NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_swap(ptr, other.ptr));
            GC.KeepAlive(this);
            GC.KeepAlive(other);
        }
        ...
        public ulong Total
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_total(ptr, out var ret));
                GC.KeepAlive(this);
                return (ulong)ret;
            }
        }
        ...
        public ulong TotalMemSize
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_totalMemSize(ptr, out var ret));
                GC.KeepAlive(this);
                return (ulong)ret;
            }
        }
        ...
        {
            ThrowIfDisposed();
            NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_type(ptr, out int ret));
            GC.KeepAlive(this);
            return ret;
        }
        ...
        public void Upload(OpenCvSharp.InputArray src)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_upload(ptr, src.CvPtr));
        ...
        public void Upload(OpenCvSharp.InputArray src, Stream? stream = null)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_upload_stream(ptr, src.CvPtr, stream?.CvPtr ?? IntPtr.Zero));
        ...
        public int Dims
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_getDims(ptr, out var ret));
                GC.KeepAlive(this);
                return ret;
            }
        }
        ...
        public int Flags
        {
            ...
            {
                ThrowIfDisposed();
                NativeMethods.HandleException(NativeMethods_cuda.cuda_GpuMatND_getFlags(ptr, out var ret));
                GC.KeepAlive(this);
                return ret;
            }
        }
        public int[] GetSize()
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_getSize(ptr, sizeArray.CvPtr));
        ...
        public ulong[] GetStep()
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_GpuMatND_getStep(ptr, stepArray.CvPtr));
