    ...
    public static class StreamAccessor
    {
        ...
        public static IntPtr GetStream(Stream stream)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_StreamAccessor_getStream(stream.CvPtr, out IntPtr handle));
        ...
        public static Stream WrapStream(IntPtr cudaStreamHandle)
        {
            ...
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_StreamAccessor_wrapStream(cudaStreamHandle, out IntPtr ptr));
