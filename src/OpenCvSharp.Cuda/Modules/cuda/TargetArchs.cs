    ...
    public static class TargetArchs
    {
        ...
        public static bool BuiltWith(FeatureSet featureSet)
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_builtWith((int)featureSet, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_has(major, minor, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_hasBin(major, minor, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_hasPtx(major, minor, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_hasEqualOrGreater(major, minor, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_hasEqualOrGreaterBin(major, minor, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_hasEqualOrGreaterPtx(major, minor, out var ret));
            return ret != 0;
        }
        ...
        {
            NativeMethods.HandleException(
                NativeMethods_cuda.cuda_TargetArchs_hasEqualOrLessPtx(major, minor, out var ret));
            return ret != 0;
        }
    }
}
