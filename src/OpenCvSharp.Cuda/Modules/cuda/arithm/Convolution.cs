...
public class Convolution : Algorithm
{
    protected Convolution(IntPtr smartPtr, IntPtr rawPtr)
        : base(smartPtr, rawPtr,p=> NativeMethods.HandleException(NativeMethods_cuda.cuda_Convolution_delete(p)))
    {
    }
    ...
    public static Convolution Create(Size? userBlockSize = null)
    {
        ...
        NativeMethods.HandleException(NativeMethods_cuda.cuda_createConvolution(sz, out var smartPtr));

        NativeMethods.HandleException(NativeMethods_cuda.cuda_Convolution_get(smartPtr, out IntPtr rawPtr));
        ...
        OpenCvSharp.Cuda.CudaOutputArray result, bool conj = false, OpenCvSharp.Cuda.Stream? stream = null)
    {
        ...
        NativeMethods.HandleException(
            NativeMethods_cuda.cuda_Convolution_convolve(
