...
/// <summary>
/// A delegate-based <see cref="OpenCvCudaPtrSafeHandle"/> that releases a native pointer
/// using a supplied release action. This avoids creating a dedicated SafeHandle subclass
/// for every OpenCV type.
/// </summary>
internal sealed class OpenCvCudaPtrSafeHandle : OpenCvSafeHandle
{
    /// <summary>
    ...
    /// </param>
    public OpenCvCudaPtrSafeHandle(IntPtr existingHandle, bool ownsHandle, Action<IntPtr>? releaseAction)
