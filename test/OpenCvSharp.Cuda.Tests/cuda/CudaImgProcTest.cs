...
public class CudaImgProcTest : CudaTestBase
{
    ...
    public void AlphaComp()
    {
        ...
        Cv2Cuda.AlphaComp(gpuImg1, gpuImg2, gpuDst, AlphaCompTypes.Over);
    ...
    public void BlendLinear()
    {
        ...
        // Act
        Cv2Cuda.BlendLinear(gpuImg1, gpuImg2, gpuW1, gpuW2, gpuDst);
    ...
    public void CvtColorBGR2GRAY()
    {
        ...
        Cv2Cuda.CvtColor(gpuSrc, gpuDst, ColorConversionCodes.BGR2GRAY);
    ...
    public void DemosaicingBayerRG2BGR()
    {
        ...
        Cv2Cuda.Demosaicing(gpuSrc, gpuDst, ColorConversionCodes.BayerRG2BGR);
    ...
    public void EqualizeHist()
    {
        ...
        // 2. Act
        Cv2Cuda.EqualizeHist(gpuSrc, gpuDst);
    ...
    public void EvenLevels()
    {
        ...
        Cv2Cuda.EvenLevels(gpuLevels,nLevels: 5, lowerLevel: 0, upperLevel: 100);
    ...
    public void HistEven()
    {
        ...
        Cv2Cuda.HistEven(gpuSrc, gpuHist, histSize: 2, lowerLevel: 0, upperLevel: 200);
    ...
    public void HistEvenMultiChannel()
    {
        ...
        // 2. Act
        Cv2Cuda.HistEven(gpuSrc, hists, sizes, lowers, uppers);
    ...
    public void HistRangeSingleChannel()
    {
        ...
        // 3. Act
        Cv2Cuda.HistRange(gpuSrc, gpuHist, gpuLevels);
    ...
    public void MeanShiftFiltering()
    {
        ...
        // Stronger parameters
        Cv2Cuda.MeanShiftFiltering(gpuSrc, gpuDst, sp: 50, sr: 20);
    ...
    public void MeanShiftProc()
    {
        ...
        Cv2Cuda.MeanShiftProc(gpuSrc, gpuColor, gpuSpatial, sp: 5, sr: 5);
    ...
    public void MeanShiftSegmentation()
    {
        ...
        Cv2Cuda.MeanShiftSegmentation(gpuSrc, gpuDst, sp: 10, sr: 10, minsize: 20);
    ...
    public void SwapChannels()
    {
        ...
        // 2. Act
        Cv2Cuda.SwapChannels(gpuSrc, dstOrder);
    ...
    public void Transpose()
    {
        ...
        // 2. Act
        Cv2Cuda.Transpose(gpuSrc, gpuDst);
    ...
    public void MomentsAccuracy()
    {
        ...
        Moments cudaM = Cv2Cuda.Moments(gpuImg, isBinary, order, momentsType);
    ...
    public void NumMomentsOrder()
    {
        ...
        int order2Count = Cv2Cuda.NumMoments(MomentsOrder.SecondOrder);
        int order3Count = Cv2Cuda.NumMoments(MomentsOrder.ThirdOrder);
    ...
    public void SpatialMomentsAsync()
    {
        ...
        // 2. Act
        Cv2Cuda.SpatialMoments(gpuSrc, gpuRawMoments, binaryImage: true, order: MomentsOrder.FirstOrder);
        ...
        Moments m = Cv2Cuda.ConvertSpatialMoments(cpuRawMoments, MomentsOrder.FirstOrder, MatType.CV_64F);
