...
public class OpenCvCudaConfigTest : CudaTestBase
{
    ...
    public void OpenCVBinaryShouldBeCompiledWithCudaSupport()
    {
        ...
        try
        {
            ...
            int deviceCount = Cv2Cuda.GetCudaEnabledDeviceCount();
    ...
    public void DeviceSupports_Test()
    {
        ...
        bool hasDouble = Cv2Cuda.DeviceSupports(FeatureSet.NativeDouble);
        bool hasCompute30 = Cv2Cuda.DeviceSupports(FeatureSet.Compute30);
