...
public class CudaLegacyTest : CudaTestBase
{
    ...
    public void ConnectivityMaskTest()
    {
        ...
        {
            // Act
            Cv2Cuda.ConnectivityMask(gpuImg, gpuMask, new Scalar(90), new Scalar(110));
        }
    ...
    public void CreateOpticalFlowNeedleMap()
    {
        ...
        // 2. Act
        Cv2Cuda.CreateOpticalFlowNeedleMap(u, v, vertex, colors);
    ...
    public void Graphcut()
    {
        ...
        try
        {
            ...
            // Act
            Cv2Cuda.Graphcut(terminals, leftTransp, rightTransp, top, bottom, labels, buf);
    ...
    public void Graphcut8()
    {
        ...
        try
        {
            ...
            // Act
            Cv2Cuda.Graphcut(terminals, leftT, rightT, top, tLeft, tRight, bot, bLeft, bRight, labels, buf);
    ...
    public void InterpolateFramesExecution()
    {
        ...
        try
        {
            ...
            // 2. Act
            Cv2Cuda.InterpolateFrames(f0, f1, fu, fv, bu, bv, 0.5f, nf, buf);
    ...
    public void LabelComponents()
    {
        ...
        try
        {
            ...
            // 2. Act
            Cv2Cuda.LabelComponents(gpuSrc, gpuLabels);
    ...
    public void ProjectPoints()
    {
        ...
        try
        {
            ...
            Cv2Cuda.ProjectPoints(gpuSrc, rvec, tvec, cameraMat, dist, gpuDst);
    ...
    public void TransformPoints()
    {
        ...
        try
        {
            ...
            // 3. Act
            using var gpuDst = new GpuMat();
            Cv2Cuda.TransformPoints(gpuSrc, rvec, tvec, gpuDst);
