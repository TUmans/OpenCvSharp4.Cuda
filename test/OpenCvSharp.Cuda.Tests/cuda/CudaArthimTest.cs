...
public class CudaArthimTest : CudaTestBase
{
    ...
    public void Absdiff()
    {
        ...
        Cv2Cuda.Absdiff(src1, src2, dst1);
        ...
        Cv2Cuda.Absdiff(src3, src4, dst2);
    ...
    public void AbsdiffWithScalar()
    {
        ...
        Cv2Cuda.Absdiff(gpuSrc, scalarToSubtract, gpuDst);
    ...
    public void AbsSum_1()
    {
        ...
        // Calculate AbsSum
        // |-5| * 4 pixels = 20
        Scalar result1 = Cv2Cuda.AbsSum(gpuSrc1);
    ...
    public void AbsSum_2()
    {
        ...
        Scalar result2 = Cv2Cuda.AbsSum(gpuSrc2, gpuMask2);
    ...
    public void Add()
    {
        ...
        // the actual function
        Cv2Cuda.Add(gpuSrc1, gpuSrc2, gpuDst);
        // downlaod results
    ...
    public void AddWeighted()
    {
        ...
        Cv2Cuda.AddWeighted(src1, 2.0, src2, 3.0, 1.0, dst);
    ...
    public void AddScalar()
    {
        ...
        using GpuMat gpuDst = new GpuMat();
        Cv2Cuda.Add(new Scalar(10), srcGpu, gpuDst);
        ...
        Cv2Cuda.Add(srcGpu, new Scalar(10), gpuDst);
        gpuDst.Download(dst);
        Assert.Equal(11, dst.At<byte>(0, 0));
        Assert.Equal(12, dst.At<byte>(0, 1));
        Assert.Equal(13, dst.At<byte>(1, 0));
    ...
    public void BitwiseAnd()
    {
        ...
        Cv2Cuda.BitwiseAnd(src1, src2, dst);
    ...
    public void BitwiseAndWithScalar()
    {
        ...
        using var gpuDst = new GpuMat();
        Cv2Cuda.BitwiseAnd(gpuSrc, new Scalar(10), gpuDst);
    ...
    public void BitwiseNot_WithEmptyMask()
    {
        ...
        Cv2Cuda.BitwiseNot(src, dst, mask: mask);
    ...
    public void BitwiseOr()
    {
        ...
        Cv2Cuda.BitwiseOr(src1, src2, dst);
    ...
    public void BitwiseOrWithScalar()
    {
        ...
        using var gpuDst = new GpuMat();
        Cv2Cuda.BitwiseOr(gpuSrc, new Scalar(12), gpuDst);
    ...
    public void BitwiseXor_1()
    {
        ...
        Cv2Cuda.BitwiseXor(src1, src2, dst);
    ...
    public void BitwiseXor_2()
    {
        ...
        Cv2Cuda.BitwiseXor(srcDst, srcDst, srcDst);
    ...
    public void BitwiseXorWithScalar()
    {
        ...
        using var gpuDst = new GpuMat();
        Cv2Cuda.BitwiseXor(gpuSrc, new Scalar(12), gpuDst);
    ...
    public void CalcAbsSumTest()
    {
        ...
        Cv2Cuda.CalcAbsSum(gpuSrc, gpuDst);
    ...
    public void CalcSqrSumTest()
    {
        ...
        Cv2Cuda.CalcSqrSum(gpuSrc, gpuDst);
    ...
    public void CalcNormTest()
    {
        ...
        Cv2Cuda.CalcNorm(gpuSrc, gpuDst, NormTypes.L1);
    ...
    public void CalcHistTest()
    {
        ...
        // Act
        Cv2Cuda.CalcHist(gpuSrc, gpuHist);
    ...
    public void CartToPolar_1()
    {
        ...
        Cv2Cuda.CartToPolar(x, y, mag, ang, angleInDegrees: true);
    ...
    public void CartToPolar_2()
    {
        ...
        Cv2Cuda.CartToPolar(x, y, mag, ang);
    ...
    public void Compare_1()
    {
        ...
        Cv2Cuda.Compare(src1, src2, dst, CmpTypes.EQ);
    ...
    public void Compare_3()
    {
        ...
        // 10 > 5 is True (255)
        Cv2Cuda.Compare(src1, src2, dst, CmpTypes.GT);
    ...
    public void Compare_4()
    {
        ...
        // 10 < 5 is False (0)
        Cv2Cuda.Compare(src1, src2, dst, CmpTypes.LT);
    ...
    public void Compare_5()
    {
        ...
        using var gpuDst = new GpuMat(); 
        Cv2Cuda.Compare(gpuSrc, new Scalar(100), gpuDst, CmpTypes.GT);
        // Assert
        using var cpuDst = new Mat();
        gpuDst.Download(cpuDst);
    ...
    public void CountNonZero_1()
    {
        ...
        int count = Cv2Cuda.CountNonZero(gpuSrc);
    ...
    public void CountNonZero_2()
    {
        ...
        using var gpuDst = new GpuMat();
            Cv2Cuda.CountNonZero(gpuSrc,gpuDst);
    ...
    public void Divide_WithScale_ReturnsScaledQuotient()
    {
        ...
        Cv2Cuda.Divide(src1, src2, dst, scale: 3.0);
    ...
    public void Lshift_ByteMatrix_ShiftsByGivenAmount()
    {
        ...
        Cv2Cuda.Lshift(src, new Scalar(3, 0, 0, 0), dst);
    ...
    public void Rshift_ByteMatrix_ShiftsByGivenAmount()
    {
        ...
        Cv2Cuda.Rshift(src, new Scalar(2, 0, 0, 0), dst);
    ...
    public void MaxWithScalar()
    {
        ...
        Cv2Cuda.Max(gpuSrc, new Scalar(100), gpuDst);
    ...
    public void Multiply_TwoMatrices_ReturnsProduct()
    {
        ...
        Cv2Cuda.Multiply(src1, src2, dst);
    ...
    public void Multiply_WithScale_ReturnsScaledProduct()
    {
        ...
        Cv2Cuda.Multiply(src1, src2, dst, scale: 0.5);
    ...
    public void Phase_PositiveXZeroY_AngleIsZero()
    {
        ...
        Cv2Cuda.Phase(x, y, ang, angleInDegrees: true);
    ...
    public void PolarToCart()
    {
        ...
        // 2. Act
        Cv2Cuda.PolarToCart(gpuMag, gpuAngle, gpuX, gpuY, angleInDegrees: true);
    ...
    public void PolarToCart_InterleavedTest()
    {
        ...
        // Act
        Cv2Cuda.PolarToCart(gpuMA, gpuXY, angleInDegrees: true);
    ...
    public void ScaleAdd_ComputesAlphaSrc1PlusSrc2()
    {
        ...
        Cv2Cuda.ScaleAdd(src1, 2.5, src2, dst);
    ...
    public void Subtract_TwoMatrices_ReturnsDifference()
    {
        ...
        Cv2Cuda.Subtract(src1, src2, dst);
    ...
    public void Threshold_BinaryType_PixelsAboveThresholdBecome255()
    {
        ...
        Cv2Cuda.Threshold(src, dst, thresh: 100.0, maxval: 255.0,
    ...
    public void Threshold_ReturnsThresholdValue()
    {
        ...
        double returned = Cv2Cuda.Threshold(src, dst,
    ...
    public void Add_NullSrc1_Throws() =>
        Assert.Throws<ArgumentNullException>(() =>
            Cv2Cuda.Add(null!, new GpuMat(), new GpuMat()));
    ...
    public void Add_NullSrc2_Throws()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            Cv2Cuda.Add(src1, null!, new GpuMat()));
    }
    ...
    public void Add_NullDst_Throws()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            Cv2Cuda.Add(src1, src2, null!));
    }

    [Fact]
    public void Threshold_NullSrc_Throws() =>
        Assert.Throws<ArgumentNullException>(() =>
            Cv2Cuda.Threshold(null!, new GpuMat(), 0, 255, ThresholdTypes.Binary));
    ...
    public void Threshold_NullDst_Throws()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            Cv2Cuda.Threshold(src, null!, 0, 255, ThresholdTypes.Binary));
    }
    ...
    public void Subtract_WithStream_VerifiesResult()
    {
        ...
        Cv2Cuda.Subtract(src1, src2, dst, stream: stream);
    ...
    public void CartToPolar_WithStream_VerifiesResult()
    {
        ...
        Cv2Cuda.CartToPolar(x, y, mag, ang, stream: stream);
        stream.WaitForCompletion();
    ...
    public void Add_WithEmptyMask_LeavesDestinationUntouched()
    {
        ...
        Cv2Cuda.Add(src1, src2, dst, mask: mask);
    ...
    public void Add_InPlace_UpdatesSourceCorrectly()
    {
        ...
        Cv2Cuda.Add(srcDst, src2, srcDst);
    ...
    public void Multiply_WithDtype_CastsOutputProperly()
    {
        ...
        Cv2Cuda.Multiply(src1, src2, dst, dtype: (int)MatType.CV_32FC1);
    ...
    public void Phase_Radians_ReturnsCorrectAngle()
    {
        ...
        Cv2Cuda.Phase(x, y, ang, angleInDegrees: false);
    ...
    public void Dft_GlobalFuncTest()
    {
        ...
        Cv2Cuda.Dft(gpuSrc, gpuDst, new Size(4, 4), DftFlags.None);
    ...
    public void FindMinMaxLoc()
    {
        ...
        // 2. Act
        Cv2Cuda.FindMinMaxLoc(gpuSrc, gpuMinMax, gpuLoc);
    ...
    public void Flip_YAxisTest()
    {
        ...
        Cv2Cuda.Flip(gpuSrc, gpuDst, FlipMode.Y);
    ...
    public void Flip_XAxisTest()
    {
        ...
        using var gpuDst = new GpuMat(); ;
        Cv2Cuda.Flip(gpuSrc, gpuDst, FlipMode.X);
    ...
    public void GammaCorrection()
    {
        ...
        // 2. Act
        Cv2Cuda.GammaCorrection(gpuSrc, gpuDst, forward: true);
    ...
    public void Gemm_BasicMultiplicationTest()
    {
        ...
        Cv2Cuda.Gemm(gpuA, gpuB, 1.0, null, 0.0, gpuDst);
    ...
    public void Gemm_WithAdditionTest()
    {
        ...
        // Act: 1.0 * (A*B) + 0.5 * C
        Cv2Cuda.Gemm(gpuA, gpuB, 1.0, gpuC, 0.5, gpuDst);
    ...
    public void Integral()
    {
        ...
        // Act
        Cv2Cuda.Integral(gpuSrc, gpuSum);
    ...
    public void MeanStdDev()
    {
        ...
        // 2. Act
        Cv2Cuda.MeanStdDev(gpuSrc, out Scalar mean, out Scalar stddev);
    ...
    public void MeanStdDev_OutputArrayTest()
    {
        ...
        // 2. Act
        Cv2Cuda.MeanStdDev(gpuSrc, gpuDst);
    ...
    public void MinWithScalar()
    {
        ...
        Cv2Cuda.Min(gpuSrc, new Scalar(100), gpuDst);
    ...
    public void MinMaxLoc_DirectTest()
    {
        ...
        // 2. Act
        Cv2Cuda.MinMaxLoc(gpuSrc, out double minVal, out double maxVal, out Point minLoc, out Point maxLoc);
    ...
    public void MinMax_WithMaskTest()
    {
        ...
        // Act
        Cv2Cuda.MinMax(gpuSrc, out double minVal, out double maxVal, gpuMask);
    ...
    public void MulSpectrums()
    {
        ...
        // 2. Act
        Cv2Cuda.MulSpectrums(gpu1, gpu2, gpuDst, DftFlags.None);
    ...
    public void MulAndScaleSpectrums()
    {
        ...
        // Act: scale = 0.5f
        using var gpuDst = new GpuMat();
        Cv2Cuda.MulAndScaleSpectrums(gpu1, gpu2, gpuDst, DftFlags.None, 0.5f);
    ...
    public void NonLocalMeans()
    {
        ...
        // Stronger filtering
        Cv2Cuda.NonLocalMeans(gpuSrc, gpuDst, h: 30.0f, searchWindow: 15, blockSize: 3);
    ...
    public void Norm_SingleMatrixTest()
    {
        ...
        // |3| + |3| + |3| + |3| = 12.0
        double l1Norm = Cv2Cuda.Norm(gpuSrc, NormTypes.L1 );

        // 3. Act: Calculate L2 Norm (Euclidean)
        // sqrt(3^2 + 3^2 + 3^2 + 3^2) = sqrt(36) = 6.0
        double l2Norm = Cv2Cuda.Norm(gpuSrc, NormTypes.L2);
    ...
    public void Norm_DifferenceTest()
    {
        ...
        // 2. Act
        double diffNorm = Cv2Cuda.Norm(gpuA, gpuB, NormTypes.L1);
    ...
    public void Normalize_MinMaxTest()
    {
        ...
        Cv2Cuda.Normalize(gpuSrc, gpuDst, 0.0, 255.0, NormTypes.MinMax, -1);
    ...
    public void RectStdDev()
    {
        ...
        try
        {
            ...
            Cv2Cuda.RectStdDev(gpuSum, gpuSqSum, gpuDst, rect);
    ...
    public void Reduce_ToRowSumTest()
    {
        ...
        Cv2Cuda.Reduce(gpuSrc, gpuVec, dim: 0, reduceOp: ReduceTypes.Sum, dtype: -1);
    ...
    public void Reduce_ToColMaxTest()
    {
        ...
        // Row 1: Max(100, 5) = 100
        using var gpuVec = new GpuMat();
        Cv2Cuda.Reduce(gpuSrc, gpuVec, dim: 1, reduceOp: ReduceTypes.Max);
    ...
    public void SqrIntegral()
    {
        ...
        // 2. Act
        Cv2Cuda.SqrIntegral(gpuSrc, gpuSqSum);
    ...
    public void SqrSum()
    {
        ...
        // 2. Act
        Scalar result = Cv2Cuda.SqrSum(gpuSrc);
    ...
    public void Subtract_MatrixScalarTest()
    {
        ...
        Cv2Cuda.Subtract(gpuSrc, new Scalar(40), gpuDst);
    ...
    public void Sum_BasicTest()
    {
        ...
        // 2. Act
        Scalar result = Cv2Cuda.Sum(gpuSrc);
    ...
    public void Sum_WithMaskTest()
    {
        ...
        // 3. Act
        Scalar result = Cv2Cuda.Sum(gpuSrc, gpuMask);
    ...
    public void Multiply_MatrixScalarTest()
    {
        ...
        Cv2Cuda.Multiply(gpuSrc, new Scalar(5), gpuDst);
    ...
    public void Multiply_WithScaleTest()
    {
        ...
        // Act
        using var gpuDst = new GpuMat();
        Cv2Cuda.Multiply(gpuSrc,  new Scalar(10), gpuDst, scale: 0.1);
