...
public class CudaWarpingTest : CudaTestBase
{
    ...
    public void BuildWarpAffineMapsTest()
    {
        ...
        Cv2Cuda.BuildWarpAffineMaps(cpuM, false, dsize, gpuXMap, gpuYMap);
    ...
    public void BuildWarpPerspectiveMapsTest()
    {
        ...
        var gpuXMap = new GpuMat();
        var gpuYMap = new GpuMat();
        Cv2Cuda.BuildWarpPerspectiveMaps(cpuM, false, dsize, gpuXMap, gpuYMap);
    ...
    public void Remap_IdentityTest()
    {
        ...
        // 3. Act
        using var gpuDst = new GpuMat();
        Cv2Cuda.Remap(gpuSrc, gpuDst, gpuMapX, gpuMapY, InterpolationFlags.Nearest);
    ...
    public void Resize_AbsoluteSizeTest()
    {
        ...
        Cv2Cuda.Resize(gpuSrc, gpuDst, new Size(200, 50));
    ...
    public void Resize_ScaleFactorTest()
    {
        ...
        using var gpuDst = new GpuMat();
        Cv2Cuda.Resize(gpuSrc, gpuDst, new Size(0, 0), fx: 0.5, fy: 0.5);
    ...
    public void WarpAffine_TranslationTest()
    {
        ...
        // 3. Act
        using var gpuDst = new GpuMat();
            Cv2Cuda.WarpAffine(gpuSrc, gpuDst, M, new Size(100, 100), InterpolationFlags.Nearest);
        // 4. Assert
        using var cpuDst = new Mat();
        gpuDst.Download(cpuDst);
    ...
    public void WarpPerspective_IdentityTest()
    {
        ...
        // 3. Act
        using var gpuDst = new GpuMat();
        Cv2Cuda.WarpPerspective(gpuSrc, gpuDst, M, new Size(50, 50));
